        ...
        <div class="container mt-5">
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="card col mb-5  mt-4">
                        <div class="card mt-4"
                            style="border: 2px solid #000; width: 100%; max-width: 900px; height: auto; margin: auto;">
                            <div class="card-header bg-dark text-white">
                                <h2 class="h5 mb-0 pt-2 pb-2">Address</h2>
                            </div>
                        </div>

                        <form class=" col mb-4 mt-4" action="" method="post" name="addressForm" id="addressForm">
                            @csrf
                            <div class="card-body p-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <h4 style="font-weight:bolder;">
                                            <label for="state_id" style="font-size: 18px;" class="text-muted">State:</label>
                                        </h4>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <h4 style="font-weight:bolder;">
                                            <label for="city_id" style="font-size: 18px;" class="text-muted">City:</label>
                                        </h4>
                                        <select name="city_id" id="city_id" class="form-control">
                                            <option value="">Select a City</option>
                                            @if ($city->isNotEmpty())
                                                @foreach ($city as $cities)
                                                    <option {{ (!empty($address) && $address->city_id == $cities->id) ? 'selected' : '' }} value="{{ $cities->id }}">{{ $cities->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <h4 style="font-weight:bolder;">
                                            <label for="postal_code" style="font-size: 18px;"
                                                class="text-muted">Zip-Code:</label>
                                        </h4>
